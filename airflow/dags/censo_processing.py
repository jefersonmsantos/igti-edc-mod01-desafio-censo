...
@dag(default_args=default_args, schedule_interval=None, catchup=False, tags=["emr", "aws", "censo"], description="Pipeline para processamento de dados do Censo escolar 2020")
def pipeline_censo():
    """
    Pipeline para processamento de dados do Censo escolar 2020.
    """
